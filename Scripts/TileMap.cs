...
public class TileMap : MonoBehaviour {
 ...
 /* [System.Serializable]
    ...
    void Start() {
        ...
        path = Application.streamingAssetsPath + "/mapdata_adventure1.json";
        LoadTilePrefabs();
	}
    ...
    public void SaveTileMapJson(string jsonName)
    {
       ...
       // tileMapMetadataWrapper wrapper = new tileMapMetadataWrapper(mapSizeX, mapSizeY, tileMapOfTypes, new int[0]);
        ...
        File.WriteAllText(path, tileMapJson);
    ...
    */
    public void LoadTileMapJson(string jsonName)
    {
        ...
        tileMapJson = File.ReadAllText(path);
...
//fai un array di RoomNumbers cosi da gestire la cosa       ok
//crea un paio di mappe VERE
//fai gli spawn points
//metti a posto il costo di movimento

//metti a posto la distruzione dei personaggi quando carichi
//fai un paio di mappe
//metti le porte nelle mappe
//metti le trappole
//testa la roba del ladro