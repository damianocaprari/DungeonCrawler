...
public class ThiefPlayer : UserPlayer {
    ...
    public void SearchForTrapsInTheRoom() {
        ...
        Debug.Log(roll + strRoom + strTraps + result);
        return;
    }

    override protected void DefuseTrap(Vector2 targetPosition) {
        ...
        if(distanceToTarget > 1) { //if absolute distance is greater than 1, return
            ...
            TrapTile targetTile = (TrapTile)gameManager.tileMap.GetTileFromCoord(targetPosition);
